       ...
       {/* Dynamic Loading State */}
            {loadingBharatPe ? (
              ( responseState?.type === 'GATEWAY_ERROR' ? (
                <div className="mt-4 p-4 rounded-xl bg-amber-50 border border-amber-200 text-amber-900 space-y-2">
                  <div className="flex items-center gap-2 font-bold text-sm">
                    <CheckCircle2 className="w-4 h-4 text-emerald-600" />
                    Database Order Created ({responseState.orderId.slice(0, 8)})
                  </div>
                  <div className="flex items-start gap-2 text-xs text-amber-800">
                    <AlertTriangle className="w-4 h-4 text-amber-600 shrink-0 mt-0.5" />
                    <span>
                      <strong>Third-Party Gateway Delay:</strong> Vyapar Gateway rejected the initialization request (HTTP 422).
                    </span>
                  </div>
              ...
              <div className="py-10 flex flex-col items-center justify-center space-y-3">
                ...
                <p className="text-xs text-gray-500 font-medium">Generating Dynamic BharatPe QR...</p>
              </div>  ))
            ) : (showDesktopBharatPeQR &&
              orderData && (
                <div className="space-y-4">
                  {/* Dynamic BharatPe QR SVG */}
                  ...
                  {/* Immediate Deep-Link App Direct Buttons */}
                  <div className="grid grid-cols-2 gap-2">
                    {intentLinks.phonepe_link && (
                      <a
                        href={intentLinks.phonepe_link}
                        className="flex items-center justify-center gap-2 py-2.5 rounded-xl bg-purple-700 hover:bg-purple-800 text-white font-medium text-xs"
                      >
                    ...
                    {intentLinks.gpay_link && (
                      <a
                        ...
                        className="flex items-center justify-center gap-2 py-2.5 rounded-xl bg-blue-600 hover:bg-blue-700 text-white font-medium text-xs"
                      >
                    ...
                    {intentLinks.paytm_link && (
                      <a
                        ...
                        className="flex items-center justify-center gap-2 py-2.5 rounded-xl bg-sky-600 hover:bg-sky-700 text-white font-medium text-xs"
                      >
                    ...
                    {intentLinks.bhim_link && (
                      <a
                        ...
                        className="flex items-center justify-center gap-2 py-2.5 rounded-xl bg-orange-600 hover:bg-orange-700 text-white font-medium text-xs"
                      >
