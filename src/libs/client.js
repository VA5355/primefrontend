...
const REACT_APP_RAZORORDERANDPAYMENTURL = "https://192.168.1.101:8000"; // `https://onedinaar.com`;
...
*/
export { API, FYERSAPI, UPSTOXAPI, ICICDIRECTAPI, FYERSAPILOGINURL, FYERSAPINSECSV, FYERSAPITRADEBOOKURL, FYERSAPIHOLDINGSURL, FYERSAPICANCELORDER, FYERSAPIBUYORDER, FYERSAPISELLORDER, FYERSAPIORDERBOOKSURL, FYERSAPITICKERURL, FYERSAPITICKERURLCLOSE, FYERSAPITICKERACCESTOKEN, FYERSAPITHREESECQUOTE, FYERSAPIGETCQUOTE, FYERSAPIMARKETFEEDRENDER, FYERSAPIMARKETCUSTOMFEED, FYERSAPIORDERSRENDER, FYERSAPIPOSITIONSRENDER, FYERSAPIPOSITIONBOOKURL, FYERSAPIMARKETFEEDRENDER_SOCKET, FYERSAPICOMPLYCUBEURL, FYERSAPIKYCORDER, UPSTOXAPILOGINURL, TRADE_LOGIN_URL, YAHOOCHARTURL, MARKETSPOTEQUITYENPOINT1, MARKETSPOTEQUITYENPOINT, REACT_APP_RAZORORDERANDPAYMENTURL, REACT_APP_RAZORORDERANDPAYMENTURL_LOCAL, REACT_APP_NGROKLOCALHOST, FYERSAUTHORISEURL, FYERSAPIURL, FYERSMODALCALLBAKURL, BASEREF, FYERSPYTONAPIBASE, FYERSPYTONAPIBASEMONGO };
